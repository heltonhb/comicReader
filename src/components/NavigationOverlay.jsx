        ...
        {showControls && (
            <>
                <motion.button
                    ...
                    className="absolute left-0 top-0 h-full w-[20%] flex items-center justify-start pl-2 md:pl-8 z-[100] group focus:outline-none touch-manipulation cursor-pointer"
                ...
                <motion.button
                    ...
                    className="absolute right-0 top-0 h-full w-[20%] flex items-center justify-end pr-2 md:pr-8 z-[100] group focus:outline-none touch-manipulation cursor-pointer"
