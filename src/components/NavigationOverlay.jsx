...
const NavigationOverlay = ({ onPrev, onNext, showControls }) => (
    <>
        ...
        >
            <div className="p-4 bg-black/20 backdrop-blur-sm border border-white/5 rounded-full text-white/70 group-hover:text-white group-hover:bg-black/40 group-hover:scale-110 transition-all duration-300 shadow-lg opacity-0 group-hover:opacity-100 -translate-x-4 group-hover:translate-x-0">
                <ChevronLeft size={32} />
            </div>
        </button>
        <button
